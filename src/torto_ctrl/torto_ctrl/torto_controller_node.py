...
from torto_ctrl.adaptive_gait.dynamic_gait import trotGait
...
class TortoControllerNode(Node):
    ...
    def control_loop(self):
        while True:
            body_Foot  = self.adpt_gait.loop(self.Vx, self.Vy, self.Vz, self.angle, self.Wrot, self.T , self.offset , self.body_Foot_Initial)
